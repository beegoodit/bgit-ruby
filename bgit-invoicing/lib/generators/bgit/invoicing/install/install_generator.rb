  ...
  module Invoicing
    module Generators
      class InstallGenerator < Rails::Generators::Base
        ...
        attr_accessor :resource_owner_factory_name, :invoice_owner_factory_name, :billed_item_billable_factory_name
        ...
        def initialize(*args)
          ...
          @billed_item_billable_factory_name = ENV.fetch("BGIT_INVOICING_BILLED_ITEM_BILLABLE_FACTORY_NAME", "billable_item")
        end
