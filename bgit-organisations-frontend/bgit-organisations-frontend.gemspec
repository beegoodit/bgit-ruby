...
require_relative "lib/bgit/organisations/frontend/version"

Gem::Specification.new do |spec|
  spec.name = "bgit-organisations-frontend"
  spec.version = Bgit::Organisations::Frontend::VERSION
  spec.authors = ["BeeGood IT"]
  spec.email = ["info@beegoodit.de"]
  spec.homepage = "https://organisations.beegoodit.de"
  spec.summary = "Beegood IT Organisations Frontend Module"
  spec.description = "Provides a end user frontend for the BeeGood IT Organisations platform."
  ...
  spec.add_dependency "bgit-organisations"
