...
require "bgit/frontend_auth/api/version"

# Describe your gem and declare its dependencies:
Gem::Specification.new do |spec|
  spec.name        = "bgit-frontend_auth-api"
  spec.version     = Bgit::FrontendAuth::Api::VERSION
  spec.authors     = ["BeeGood IT"]
  spec.email       = ["it@beegoodit.de"]
  spec.homepage    = "https://www.beegoodit.de"
  spec.summary     = "BeeGood IT End User Authentication API Module."
  spec.license     = "MIT"
