...
require_relative "lib/bgit/frontend_auth/version"

Gem::Specification.new do |spec|
  spec.name = "bgit-frontend_auth"
  spec.version = Bgit::FrontendAuth::VERSION
  spec.authors = ["BeeGood IT"]
  spec.email = ["info@beegoodit.de"]
  spec.homepage = "https://hosting.beegoodit.de"
  spec.summary = "BeeGood IT End User Frontend Auth Module"
  spec.description = "Provides end user frontend authentication."
