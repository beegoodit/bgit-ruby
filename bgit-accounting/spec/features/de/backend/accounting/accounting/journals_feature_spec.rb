...
RSpec.describe "/de/backend/accounting/accounting/journals", type: :feature do
  let(:resource_class) { Bgit::Accounting::Accounting::Journal }
  ...
  describe "REST actions" do
    ...
    describe "create", type: :system, js: true do
      it {
        ...
        expect(subject).to implement_create_action(self)
          .for(resource_class)
          .within_form("#new_accounting_journal") {
    ...
    it {
      expect(subject).to implement_update_action(self)
        .for(resource)
        .within_form(".edit_accounting_journal") {
          # fill the needed form inputs via capybara here
          #
          # Example:
          #
