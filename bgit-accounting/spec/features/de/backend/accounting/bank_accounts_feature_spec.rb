      ...
      it {
        ...
        expect(subject).to implement_create_action(self)
          ...
          .within_form("body") {
            ...
            polymorphic_select(user, :human, from: "bank_account[accountable_id]")
            fill_in "bank_account[name]", with: "Bank-Konto"
            fill_in "bank_account[owner]", with: "Jane Doe"
            fill_in "bank_account[iban]", with: "DE42 1234 5678 9012 34"
          }
